...
var carrito = {
    ...
    render_carrito: function(data_json, animar) {
        ...
        boton_finalizar = "<div onclick=\"carrito.limpiar_carrito()\" id=\"finalizar_compra\" style=\"display:none\">Realizar Pedido</div>";
        str = "<div id=\"carrito_content\" onclick=\"carrito.abrir_carrito()\"><div id=\"tupedido\">Tu Pedido</div>";
        str += loading+quemas;
